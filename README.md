...
```bash
npm install eslint @odg/eslint-config-odg-linter-js eslint-plugin-jsdoc@* eslint-plugin-import@* --save-dev
# or
yarn add -D eslint @odg/eslint-config-odg-linter-js eslint-plugin-jsdoc@* eslint-plugin-import@*
```
